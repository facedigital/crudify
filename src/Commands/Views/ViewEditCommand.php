...
class ViewEditCommand extends GeneratorCommand
{
    ...
    public function compileStub(): string
    {
        ...
        $content = (new ViewEditSyntaxBuilder())->create($schema);
    ...
    {
        return sprintf('%s.blade.php', 'edit');
    }
}
